...
function Cart() {
  ...
  const handleIncreaseQuantity = (item) => {
    ...
    dispatch(updateItemQuantity({ productId: item.Product.id, quantity: newQuantity }));
  };
          ...
          <>
              ...
              >
                ...
                cartItems.map((item) => (
                  ...
                  >
                    <Box
                      component="img"
                      src={item.Product?.Images[1]?.image_location||''}
                    ...
                    <Box textAlign={"center"}>
                      <Typography variant="h6" color="error">{item.Product.price}</Typography>
            ...
            <Grid2 size={4}>
              ...
              >
                ...
                <Typography variant="body2" textAlign={"start"} sx={{mt:1,mb:1}}>Product Price: {totalPrice} EGP </Typography>
                <Typography variant="body2"textAlign={"start"} sx={{mt:1,mb:1}}> Shipping price: 0</Typography>
